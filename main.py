...
token = 'X' #This is X your Telegram Bot id

app = Flask(__name__)
sslify = SSLify(app)


def write_json(data, filname='response.json'):
...
# https://api.telegram.org/bot X/getMe

# https://api.telegram.org/bot X /sendMessage?chat_id=651267590&text=Hello user

# https://api.telegram.org/bot X /setWebhook?url=https://aqacas.pythonanywhere.com/
